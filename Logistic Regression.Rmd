...
---
This is logistic regression.I am going to use 'Newton-Raphson Method'(here equivalent to Fisher's Scoring method ) to solve regression coefficient  estimate Beta.
```{r}
...
```
The regression coefficient estimate is 
```{r}
BNEW
```
